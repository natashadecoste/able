...
function loadPinsModel() {
    ...
    mtlLoader.setPath('../public/game/models/pins/');
    mtlLoader.load('Pin.mtl', function (materials) {
        ...
        objLoader.setPath('../public/game/models/pins/');
...
function drawMainPins() {
    ...
    for (var x = 0; x < 4; x++) {
        ...
        box.name = "pin";
        box.position.set(490, height+10, -26 + 18 * x);
        box.add(pin);
        scene.add(box);
    }
    ...
    for (var x = 0; x < 3; x++) {
        ...
        box = new Physijs.BoxMesh(boxGeometry, upBoxMaterial, gravity);
        box.name = "pin";
        box.position.set(475, height+10, -18 + 18 * x);
    ...
    for (var x = 0; x < 2; x++) {
        ...
        box = new Physijs.BoxMesh(boxGeometry, upBoxMaterial, gravity);
        box.name = "pin";
        box.position.set(450, height+10, -10 + 18 * x);
        box.add(pin);
        scene.add(box);
    }
    ...
    pin.name = "pin";
    box.name = "pin";
    box.position.set(435, height+10, 0);
    box.add(pin);
    scene.add(box);
}
