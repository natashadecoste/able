...
function addLanes(parent, width, length, height, laneLength, laneWidth, guardHeight, laneAmount) {
    ...
    var sideTexture = new THREE.TextureLoader().load('../public/game/textures/fun2.jpg');
    ...
    var columnTexture = new THREE.TextureLoader().load('../public/game/textures/wood.jpg');
...
function createLaneBase(width, length, thickness) {
    ...
    var floorTexture = new THREE.TextureLoader().load('../public/game/textures/floor.png');
...
function createEnclosing(width, length, height) {
    ...
    var topTexture = new THREE.TextureLoader().load("../public/game/textures/ceiling.jpg");
   ...
   // var wallTexture = new THREE.TextureLoader().load("textures/wp2863950.gif");
    ...
    var frontPanelTexture = new THREE.TextureLoader().load("../public/game/textures/109.jpg");
    ...
    var frontUpperPanelTexture = new THREE.TextureLoader().load("../public/game/textures/space.jpg");
...
function createTV() {
    ...
    var tvTexture = new THREE.TextureLoader().load("../public/game/textures/TV.jpg");
    ...
    videoStrike.src = "../public/game/videos/bowlingstrike1.mp4";
    videoStrike.load();

    videoSpare = document.createElement('video');
    videoSpare.src = "../public/game/videos/bowlingspare2.mp4";
    videoSpare.load();
...
function createLaneNumbers() {
    ...
    loader.load('../public/game/fonts/helvetiker_regular.typeface.json', function (font) {
